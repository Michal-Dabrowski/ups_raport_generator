...
if __name__ == '__main__':
    data_frame = CSVData('csv_shipping_history.csv')
    data_frame.main()

    excel_file = CreateExcelFile('Raport UPS', data_frame=data_frame.data_frame_processed)
    excel_file.main()
    excel_file.save_excel_file('test')